...
// On va créer une condition qui conditionne l'éxecution de ce code uniquement lorsque l'utilisateur est connecté // 
                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="inputFirstName" type="text" name="prenom" value="<?= $artiste['prenom'] ?>" />
                                                <label for="inputFirstName">Prénom</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="inputLastName" type="text" name="nom" value="<?= $artiste['nom'] ?>" />
                                                <label for="inputLastName">Nom</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputEmail" type="email" name="email" value="<?= $artiste['email'] ?>" />
                                        <label for="inputEmail">Adresse email</label>
                                    </div>

                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="biographie" type="text" placeholder="courte biograhie" name="biographie">

                                        <?php echo $artiste['biographie']; ?>
                                        </textarea>
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid">
                                            <input type="submit" name="update_profil" value="Mettre a jour mon profile" class="btn btn-primary">
                                        </div>
                                </form>
                            </div>
